		...
		<div class="sm:flex sm:items-center sm:justify-between">
			...
			<div class="mt-4 flex sm:mt-0 sm:justify-center">
				...
				<a href="#" class="ms-5 text-gray-500 hover:text-gray-900 dark:hover:text-white">
					...
					>
						<path
							d="M7.75 2h8.5A5.75 5.75 0 0 1 22 7.75v8.5A5.75 5.75 0 0 1 16.25 22h-8.5A5.75 5.75 0 0 1 2 16.25v-8.5A5.75 5.75 0 0 1 7.75 2zm0 1.5A4.25 4.25 0 0 0 3.5 7.75v8.5A4.25 4.25 0 0 0 7.75 20.5h8.5a4.25 4.25 0 0 0 4.25-4.25v-8.5A4.25 4.25 0 0 0 16.25 3.5h-8.5zm8.25 2a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm-4.25 1.25a4.5 4.5 0 1 1 0 9 4.5 4.5 0 0 1 0-9zm0 1.5a3 3 0 1 0 0 6 3 3 0 0 0 0-6z"
						/>
					</svg>
